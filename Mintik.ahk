...
;===================================================================================
change:
    MsgBox, 8192, Обновление от 18.12.2024 включает в себя:, 
.байк - Мотоцикл должен быть Ваш, нажимаете ctrl и едете на зданем колесе.`n
.гв - Это режим на Maze Bank Arena. Ее можете найти на карте.`n
return
;===================================================================================
