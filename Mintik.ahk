...
;===================================================================================
change:
    MsgBox, 8192, 29.01.2025 Обновления:`n , - .янкт - Если я Вас телепортирую, у Вас сбросится квест. К сожалению, иных способов решения данной проблемы - нет. Нужно телепортировать?`n -.янкт2 - Я не могу помочь Вам, так как Вы на Квесте в Янктоне. Если я что-либо с Вами сделаю сброситься квест.
return
;===================================================================================
