...
Gui, Fractions: Add, Text, x106 y24  h20 +0x300 cred, БатлПасс
    ...
    Gui, Fractions: Add, Text, x8 y280  h20 +0x300,.угонбп - Чтобы угнать транспорт, Вам необходимо находиться в криминальной организации. Далее купить программатор ЭБУ на рынке. Сесть на водительское место - G - взломать. 
