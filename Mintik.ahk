...
;===================================================================================
change:
    MsgBox, 8192, 01.02.2025 Обновления:`n , .сек - Здравствуйте, сейчас помогу вам. (Сделано на подобе .ку)`n
.сорянчик - Приносим свои извинения за предоставленные неудобства.`n
.жба - Вы можете написать жалобу на форум, если не согласны с решением администратора.`n
.емс2 - К сожалению, не видя всей ситуации мы не в праве лечить,поднимать или добивать игроков. Дождитесь сотрудников EMS либо же окончания таймера смерти. Приносим свои извинения за возможные неудобства. `n
.ржб2 - Жалобы, содержащие видеофрагменты продолжительностью более 1-й минуты, а также не очевидные и сложные нарушения не подлежат рассмотрению в Обращение. Стоит оформить жалобу на форум. Благодарю за понимание.`n
.клирчат - /aclearchat`n
.багвойс2 - Для того, чтобы заработал войс, Вам нужно перезайти в игру.`n
.мсл - Обратитесь к Организатором MCL в Дискорде.`n
.авто - Восстановили`n
.нрф - /ajail 15 nonRP Fly`n
.нрф25 - /ajail 25 nonRP Fly `n
return
;===================================================================================
