...
;===================================================================================
    ...
    Gui, Commandlist: Add, Text, x8 y104  h20 +0x200, 
    Gui, Commandlist: Add, Text, x8 y120  h20 +0x200, 
    Gui, Commandlist: Add, Text, x8 y136  h20 +0x200,  
    Gui, Commandlist: Add, Text, x8 y152  h20 +0x200,  
...
:?:.непр::Не предоставляем подобную информацию.
:?:/cel::Снять судимость Вы можете в Govermente.
:?:.суд::Снять судимость Вы можете в Govermente.
...
:?:.мусор::Чтобы открыть мусорку нужно подойти к ней и нажать Е, так же вам сообщаю что не все мусорки можно просмотреть. Расположение мусорок вы можете узнать на сайте https://wiki.majestic-rp.ru/ru/map/rubbish, либо же самостоятельным поиском.
...
:?:.угонбп::Чтобы угнать транспорт вам необходимо находится в криминальной организации. Далее купить прогромматор ЭБУ на рынке. Сесть на водительское место - G - взломать.
