...
:?:.квр::У бота на работе будет кнопка "Я могу чем-то помочь". Вы на неё жмёте и у вас откроется квест, который нужно выполнить. Выполняете этот квест и Вам засчитывает задание.
...
:?:.уход4::/hardban 4 Уход от RP{Left 12}
...
:?:/e[jl4::/hardban 4 Уход от RP{Left 12}
